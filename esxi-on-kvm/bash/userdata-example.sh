...
sed -i "s/DNSIPADDRESS1=/DNSIPADDRESS1=$DNSIPADDRESS1/g" $ESXIROOT/main.sh
sed -i "s/DNSIPADDRESS2=/DNSIPADDRESS2=$DNSIPADDRESS2/g" $ESXIROOT/main.sh
sed -i "s/VCSAISO=/VCSAISO=$VCSAISO/g" $ESXIROOT/main.sh
sed -i "s/VSPHEREVERSION=/VSPHEREVERSION=$VSPHEREVERSION/g" $ESXIROOT/main.sh
sed -i "s/DNSDOMAIN=/DNSDOMAIN=$DNSDOMAIN/g" $ESXIROOT/main.sh
sed -i "s/ADPASSWORD=/ADPASSWORD=$ADPASSWORD/g" $ESXIROOT/main.sh
sed -i "s/ADUSER=/ADUSER=$ADUSER/g" $ESXIROOT/main.sh
sed -i "s/HOSTPASSWORD=/HOSTPASSWORD=$HOSTPASSWORD/g" $ESXIROOT/main.sh
sed -i "s/SSOPASSWORD=/SSOPASSWORD=$SSOPASSWORD/g" $ESXIROOT/main.sh
