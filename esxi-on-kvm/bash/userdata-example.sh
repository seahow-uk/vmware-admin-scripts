...
sed "0,/DNSIPADDRESS1=/s/DNSIPADDRESS1=$DNSIPADDRESS1/" $ESXIROOT/main.sh
sed "0,/DNSIPADDRESS2=/s/DNSIPADDRESS2=$DNSIPADDRESS2/" $ESXIROOT/main.sh
sed "0,/VCSAISO=/s/VCSAISO=$VCSAISO/" $ESXIROOT/main.sh
sed "0,/VSPHEREVERSION=/s/VSPHEREVERSION=$VSPHEREVERSION/" $ESXIROOT/main.sh
sed "0,/DNSDOMAIN=/s/DNSDOMAIN=$DNSDOMAIN/" $ESXIROOT/main.sh
sed "0,/ADPASSWORD=/s/ADPASSWORD=$ADPASSWORD/" $ESXIROOT/main.sh
sed "0,/ADUSER=/s/ADUSER=$ADUSER/" $ESXIROOT/main.sh
sed "0,/HOSTPASSWORD=/s/HOSTPASSWORD=$HOSTPASSWORD/" $ESXIROOT/main.sh
sed "0,/SSOPASSWORD=/s/SSOPASSWORD=$SSOPASSWORD/" $ESXIROOT/main.sh
